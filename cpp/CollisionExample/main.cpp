...
int main() {
    ...
    dart::dynamics::SkeletonPtr ground = urdfLoader.parseSkeleton(
            "/Users/junhyeok/Repository/MotionCtrl/cpp/CollisionExample/RobotModel/ground.urdf");
    dart::dynamics::SkeletonPtr robot = urdfLoader.parseSkeleton(
            "/Users/junhyeok/Repository/MotionCtrl/cpp/CollisionExample/RobotModel/box.urdf");
    ...
    //// Wrap a worldnode
    osg::ref_ptr<ColWorldNode> node
        = new ColWorldNode(world);
